...
csvs_path = './csv-coyhaique'
csvs_files = sorted(glob.glob(csvs_path + '/*.csv'))
coyhaique_DataFrame = pd.DataFrame()
...
for station in stations:
    ...
    coyhaique_DataFrame = coyhaique_DataFrame.append(df)
    pass
coyhaique_DataFrame.to_csv("coyhaique.csv", index=False)
